...
export default function Links(){
    ...
    return(
        <Box sx={{position: 'relative', top: '30pc', left : '10pc'}} w={[300,600]}>
            <Stack direction={['column', 'row']} sx={{color: 'darkslategrey'}}>
            ...
            <Box sx={{position: 'relative', top : '0pc', left: '-14pc'}} w={[300, 600]}>
